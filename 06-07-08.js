...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      const amigo = this.amigos.map((friends)=>{
        return friends['nombre'];
      });
      // Tu código aca:
      return amigo
    }
    ...
    getHobbies() {
      ...
      // Tu código aca:
      const hobbie = this.hobbies.map((hobb)=>{
        return hobb;
      })
      // Tu código aca:
      return hobbie
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var promedio = 0, numElementos = 0, suma = 0; 
      this.amigos.forEach(element => {
        suma+= element.edad;
      });
      numElementos =  this.amigos.length;
